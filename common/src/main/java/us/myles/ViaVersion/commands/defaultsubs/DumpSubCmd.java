        ...
        Via.getPlatform().runAsync(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    sender.sendMessage("§cFailed to dump, please check the console for more information");
                ...
                try {
                    ...
                    if (con.getResponseCode() == 429) {
                        sender.sendMessage("§cYou can only paste ones every minute to protect our systems.");
                        return;
                    }
                    ...
                    sender.sendMessage("§aWe've made a dump with useful information, report your issue and provide this url: " + getUrl(output.get("key").getAsString()));
                } catch (Exception e) {
                    sender.sendMessage("§cFailed to dump, please check the console for more information");
