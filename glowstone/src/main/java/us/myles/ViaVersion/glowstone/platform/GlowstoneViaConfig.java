...
public class GlowstoneViaConfig extends Config implements ViaVersionConfig {
    ...
    public URL getDefaultConfigURL() {
        return GlowstoneViaConfig.class.getClassLoader().getResource("assets/viaversion/config.yml");
    }
